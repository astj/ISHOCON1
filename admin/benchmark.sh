...
$DIR/bin/benchmark "$@" | /opt/mackerel-agent/plugins/bin/mackerel-plugin-json -stdin -prefix $MACKEREL_SERVICE_METRIC_PREFIX | sed "s/score/score-$TEAMNAME/" | mkr throw -s $MACKEREL_SERVICE
